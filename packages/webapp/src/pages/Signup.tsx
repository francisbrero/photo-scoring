        ...
        <div className="w-full max-w-md">
          <div className="bg-[var(--bg-secondary)] rounded-xl p-8 shadow-lg text-center">
            ...
            <p className="text-[var(--text-secondary)] mb-6">
              ...
              Click the link to activate your account and get your 5 free credits!
            </p>
            <Link
              to="/login"
      ...
      <div className="w-full max-w-md">
        <div className="bg-[var(--bg-secondary)] rounded-xl p-8 shadow-lg">
          ...
          <p className="text-[var(--text-muted)] text-center mb-6">
            Start with 5 free photo credits
          </p>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white text-gray-800 rounded-lg hover:bg-gray-100 transition-colors font-medium"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-sm text-[var(--text-muted)]">
              ...
              <a href="#" className="text-[#e94560] hover:underline">Terms of Service</a>
              {' '}and{' '}
              <a href="#" className="text-[#e94560] hover:underline">Privacy Policy</a>.
            </div>
