        ...
        <div className="bg-gray-900/50 rounded-xl p-6 mb-8 text-left">
          ...
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-start">
              ...
              <span><strong>No cloud storage</strong> - your photos are never stored on our servers. Image data may be sent to AI providers for analysis.</span>
            </li>
            <li className="flex items-start">
              <svg className="w-5 h-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <li className="flex items-start">
              ...
              <span><strong>Your data</strong> - photos are analyzed but never stored in the cloud</span>
            </li>
            <li className="flex items-start">
              <svg className="w-5 h-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
