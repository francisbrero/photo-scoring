...
export function Layout({ children, onSettingsClick, onTriageClick }: LayoutProps) {
  return (
        ...
        <div className="flex items-center gap-2">
          {onTriageClick && (
            <button
              ...
              className="px-3 py-1.5 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-lg non-draggable transition-colors"
              title="Triage Photos"
            >
              Triage
            </button>
